...
class preprocess(torch.nn.Module):
    ...
    def __init__(self, initial_dim, MLP_layernum=0, dropout_rate=0., norm_type='layer',
                 simple_distance='Y'):
        super(preprocess, self).__init__()

        prelayerpreset = [800, 400, initial_dim]
        self.prelayernum = []
        self.prelayernum.append(512)
        for i in range(0, MLP_layernum):
        ...
        self.prelayer_last = Linear(self.prelayernum[-1], initial_dim)
